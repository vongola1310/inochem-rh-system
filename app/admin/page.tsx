...
import { CheckCircle, Users, ClipboardList, FileText, Calendar, Home, ArrowLeft } from 'lucide-react'
                    ...
                    <TableRow>
                      <TableCell colSpan={7} className="text-center h-32">
                        <div className="flex flex-col items-center justify-center gap-2 text-slate-400">
                          ...
                          <p className="text-sm">Todas las solicitudes críticas han sido procesadas</p>
                        </div>
                      </TableCell>
                    </TableRow>
                  ) : (
